...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.DeviceInfo.AppStateLifecyle, Plugin.DeviceInfo", AppStateLifecyle.class, __md_methods);
	}


	public AppStateLifecyle ()
	{
		super ();
		if (getClass () == AppStateLifecyle.class)
			mono.android.TypeManager.Activate ("Plugin.DeviceInfo.AppStateLifecyle, Plugin.DeviceInfo", "", this, new java.lang.Object[] {  });
	}
